 ...
 */Object.defineProperty(e,"__esModule",{value:!0}),e.ExtendedMesh=void 0;const s=o(0);class i extends s.Mesh{constructor(t,e){super(t,e),this.vector3=new s.Vector3,this.isGroup=!1,this.hasBody=!1,this.name="object-"+this.id}get world(){return{theta:this.worldTheta,phi:this.worldPhi}}get worldTheta(){return this.getWorldDirection(this.vector3),Math.atan2(this.vector3.x,this.vector3.z)}get worldPhi(){return this.getWorldDirection(this.vector3),Math.acos(this.vector3.y)}}e.ExtendedMesh=i},function(t,e,o){"use strict";var s=Object.prototype.hasOwnProperty,i="~";function n(){}function r(t,e,o){this.fn=t,this.context=e,this.once=o||!1}function a(t,e,o,s,n){if("function"!=typeof o)throw new TypeError("The listener must be a function");var a=new r(o,s||t,n),l=i?i+e:e;return t._events[l]?t._events[l].fn?t._events[l]=[t._events[l],a]:t._events[l].push(a):(t._events[l]=a,t._eventsCount++),t}function l(t,e){0==--t._eventsCount?t._events=new n:delete t._events[e]}function m(){this._events=new n,this._eventsCount=0}Object.create&&(n.prototype=Object.create(null),(new n).__proto__||(i=!1)),m.prototype.eventNames=function(){var t,e,o=[];if(0===this._eventsCount)return o;for(e in t=this._events)s.call(t,e)&&o.push(i?e.slice(1):e);return Object.getOwnPropertySymbols?o.concat(Object.getOwnPropertySymbols(t)):o},m.prototype.listeners=function(t){var e=i?i+t:t,o=this._events[e];if(!o)return[];if(o.fn)return[o.fn];for(var s=0,n=o.length,r=new Array(n);s<n;s++)r[s]=o[s].fn;return r},m.prototype.listenerCount=function(t){var e=i?i+t:t,o=this._events[e];return o?o.fn?1:o.length:0},m.prototype.emit=function(t,e,o,s,n,r){var a=i?i+t:t;if(!this._events[a])return!1;var l,m,c=this._events[a],h=arguments.length;if(c.fn){switch(c.once&&this.removeListener(t,c.fn,void 0,!0),h){case 1:return c.fn.call(c.context),!0;case 2:return c.fn.call(c.context,e),!0;case 3:return c.fn.call(c.context,e,o),!0;case 4:return c.fn.call(c.context,e,o,s),!0;case 5:return c.fn.call(c.context,e,o,s,n),!0;case 6:return c.fn.call(c.context,e,o,s,n,r),!0}for(m=1,l=new Array(h-1);m<h;m++)l[m-1]=arguments[m];c.fn.apply(c.context,l)}else{var d,u=c.length;for(m=0;m<u;m++)switch(c[m].once&&this.removeListener(t,c[m].fn,void 0,!0),h){case 1:c[m].fn.call(c[m].context);break;case 2:c[m].fn.call(c[m].context,e);break;case 3:c[m].fn.call(c[m].context,e,o);break;case 4:c[m].fn.call(c[m].context,e,o,s);break;default:if(!l)for(d=1,l=new Array(h-1);d<h;d++)l[d-1]=arguments[d];c[m].fn.apply(c[m].context,l)}}return!0},m.prototype.on=function(t,e,o){return a(this,t,e,o,!1)},m.prototype.once=function(t,e,o){return a(this,t,e,o,!0)},m.prototype.removeListener=function(t,e,o,s){var n=i?i+t:t;if(!this._events[n])return this;if(!e)return l(this,n),this;var r=this._events[n];if(r.fn)r.fn!==e||s&&!r.once||o&&r.context!==o||l(this,n);else{for(var a=0,m=[],c=r.length;a<c;a++)(r[a].fn!==e||s&&!r[a].once||o&&r[a].context!==o)&&m.push(r[a]);m.length?this._events[n]=1===m.length?m[0]:m:l(this,n)}return this},m.prototype.removeAllListeners=function(t){var e;return t?(e=i?i+t:t,this._events[e]&&l(this,e)):(this._events=new n,this._eventsCount=0),this},m.prototype.off=m.prototype.removeListener,m.prototype.addListener=m.prototype.on,m.prefixed=i,m.EventEmitter=m,t.exports=m},function(t,e,o){"use strict";
/**
 * @author       Yannick Deubel (https://github.com/yandeu)
 * @copyright    Copyright (c) 2020 Yannick Deubel; Project Url: https://github.com/enable3d/enable3d
 * @license      {@link https://github.com/enable3d/enable3d/blob/master/LICENSE|GNU GPLv3}
